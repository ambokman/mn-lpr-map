const colors={city:'#3bc8ff',county:'#a36bff',state:'#ffd34d',private:'#ff9d42'};
...
function initMap(){
  ...
  status.id='mapStatus';
  status.innerHTML='<b>Map:</b> known LPR records shown with category-colored pins. Some non-verified coordinates may be approximate.';
